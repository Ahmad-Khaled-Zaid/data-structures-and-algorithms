...
const sortNumbersByLength = (arr) => {
  ...
  return StringsArr.map((value) => parseFloat(value));
};
...
const sortPeople = (arr) => {
  ...
  return arr.sort((value1, value2) => {
    ...
    if (value2.lastName > value1.lastName) {
      return -1;
    }
    return 0;
  });
...
const sortPeopleBetter = (arr) => {
  ...
  return arr.sort((value1, value2) => {
    ...
    if (value3 > value4) {
      ...
      value3 = value1.firstName.toLowerCase();
      value4 = value2.firstName.toLowerCase();
      if (value3 > value4) {
        return 1;
      } else if (value4 > value3) {
        return -1;
